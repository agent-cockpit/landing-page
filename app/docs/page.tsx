      ...
      <div className="shell">
        ...
        <main className="content" ref={contentRef} id="content">
          ...
          <article className={`doc-page${current === "getting-started" ? " active" : ""}`}>
            ...
            <div className="code-block"><span className="cb-lang">MAC / LINUX</span><span className="c"># Shell installer</span><br /><span className="p">$</span> curl -fsSL https://claude.ai/install.sh | bash<br /><br /><span className="c"># Authenticate</span><br /><span className="p">$</span> claude auth login</div>
            <div className="code-block"><span className="cb-lang">WINDOWS</span><span className="c"># PowerShell installer</span><br />{">"} irm https://claude.ai/install.ps1 | iex<br /><br /><span className="c"># Authenticate</span><br />{">"} claude auth login</div>
            ...
            <div className="code-block"><span className="cb-lang">ALL OS</span><span className="p">$</span> npm install -g @openai/codex<br /><br /><span className="c"># Set your API key (Mac / Linux)</span><br /><span className="p">$</span> export OPENAI_API_KEY=sk-...<br /><br /><span className="c"># Set your API key (Windows PowerShell)</span><br />{">"} {`$env:OPENAI_API_KEY = "sk-..."`}<br /><br /><span className="c"># Verify</span><br /><span className="p">$</span> codex --version</div>
            ...
            <div className="code-block"><span className="cb-lang">TREE</span>agent-cockpit/<br /><span className="c"># Node.js session manager + WebSocket server</span><br />├── <span className="p">daemon/</span><br />│   ├── src/<br />│   └── package.json<br /><span className="c"># React + Vite browser app</span><br />├── <span className="p">ui/</span><br />│   ├── src/<br />│   │   ├── components/<br /><span className="c">│   │   # Canvas game engine</span><br />│   │   ├── game/<br />│   │   ├── pages/<br />│   │   └── store/<br />│   └── package.json<br />└── pnpm-workspace.yaml</div>
          ...
          <article className={`doc-page${current === "providers" ? " active" : ""}`}>
            ...
            <div className="code-block"><span className="cb-lang">MAC / LINUX</span><span className="c"># Shell installer</span><br /><span className="p">$</span> curl -fsSL https://claude.ai/install.sh | bash<br /><br /><span className="c"># Authenticate (opens browser)</span><br /><span className="p">$</span> claude auth login<br /><br /><span className="c"># Verify</span><br /><span className="p">$</span> claude --version</div>
            <div className="code-block"><span className="cb-lang">WINDOWS</span><span className="c"># PowerShell installer</span><br />{">"} irm https://claude.ai/install.ps1 | iex<br /><br /><span className="c"># Authenticate (opens browser)</span><br />{">"} claude auth login<br /><br /><span className="c"># Verify</span><br />{">"} claude --version</div>
            ...
            <h3 className="doc-h3">Setup</h3>
            <div className="code-block"><span className="cb-lang">BASH</span><span className="c"># Install Codex CLI</span><br /><span className="p">$</span> npm install -g @openai/codex<br /><br /><span className="c"># Set your API key</span><br /><span className="p">$</span> export OPENAI_API_KEY=sk-...<br /><br /><span className="c"># Verify</span><br /><span className="p">$</span> codex --version</div>
          ...
          <article className={`doc-page${current === "contributing" ? " active" : ""}`}>
            ...
            <div className="code-block"><span className="cb-lang">BASH</span><span className="c"># Fork and clone</span><br /><span className="p">$</span> git clone https://github.com/YOUR_FORK/agent-cockpit.git<br /><span className="p">$</span> cd agent-cockpit && pnpm install<br /><br /><span className="c"># Create a branch</span><br /><span className="p">$</span> git checkout -b feat/your-feature<br /><br /><span className="c"># Start dev server</span><br /><span className="p">$</span> pnpm dev<br /><br /><span className="c"># Run tests (watch mode)</span><br /><span className="p">$</span> pnpm test --watch</div>
